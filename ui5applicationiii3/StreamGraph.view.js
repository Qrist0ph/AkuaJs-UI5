sap.ui.jsview("ui5applicationiii3.StreamGraph", {

    createContent: function (oController) {

        jQuery.sap.require("AkuaJs.StreamGraph");
             ...
             new sap.m.Link({
                 ...
                 new sap.m.Label({
                   ...
                   new sap.ui.core.HTML({
                       content: ' '
                       + '<pre><code id="2FDF9430-E886-4231-9325-6EBBD27F8092">'
                       + 'jQuery.sap.require("AkuaJs.StreamGraph"); <br/>'
  + ' <br/>'
